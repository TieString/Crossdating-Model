...
These 15 files are the exact shortest source closure recovered from the final v5 research run. They are retained for auditability and to explain how the frozen candidate matrix was built.
